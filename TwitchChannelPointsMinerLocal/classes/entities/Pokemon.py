...
POKEMON_WITH_ALTERNATE_VERSIONS = ["Abomasnow", "Absol", "Aegislash", "Aerodactyl", "Aggron", "Aipom", "Alakazam", "Alcremie", "Altaria", "Ambipom", "Ampharos", "Appletun", "Arcanine", "Arceus", "Articuno", "Audino", "Banette", "Basculegion", "Basculin", "Beautifly", "Beedrill", "Bibarel", "Bidoof", "Blastoise", "Blaziken", "Braviary", "Buizel", "Burmy", "Butterfree", "Cacturne", "Calyrex", "Camerupt", "Castform", "Centiskorch", "Charizard", "Cherrim", "Coalossal", "Cosmog", "Darmanitan", "Deoxys", "Diancie", "Diglett", "Dugtrio", "Exeggutor", "Floette", "Gallade", "Garchomp", "Gardevoir", "Gengar", "Geodude", "Giratina", "Glalie", "Golem", "Goodra", "Gourgeist", "Graveler", "Grimer", "Groudon", "Growlithe", "Gyarados", "Heracross", "Hippowdon", "Hoopa", "Houndoom", "Kangaskhan", "Kartana", "Keldeo", "Kyogre", "Kyurem", "Landorus", "Latias", "Latios", "Lilligant", "Lopunny", "Lucario", "Lycanroc", "Magnemite", "Manectric", "Marowak", "Mawile", "Medicham", "Meloetta", "Meowstic", "Meowth", "Metagross", "Mewtwo", "Minior", "Moltres", "Morpeko", "Mr-Mime", "Muk", "Murkrow", "Necrozma", "Ninetales", "Numel", "Nuzleaf", "Octillery", "Orbeetle", "Oricorio", "Overqwil", "Pachirisu", "Palossand", "Persian", "Pidgeot", "Pikachu", "Piloswine", "Pinsir", "Politoed", "Polteageist", "Ponyta", "Pumpkaboo", "Pyroar", "Quagsire", "Raichu", "Rapidash", "Raticate", "Rattata", "Rayquaza", "Relicanth", "Rhydon", "Rhyperior", "Rockruff", "Roselia", "Roserade", "Rotom", "Sableye", "Salamence", "Sandaconda", "Sandshrew", "Sandslash", "Sawsbuck", "Sceptile", "Scizor", "Scyther", "Sharpedo", "Shaymin", "Shellos", "Shiftry", "Shinx", "Silvally", "Sinistea", "Slowbro", "Steelix", "Swampert", "Thundurus", "Tornadus", "Tyranitar", "Venusaur", "Vivillon", "Voltorb", "Vulpix", "Weavile", "Weezing", "Wishiwashi", "Wobbuffet", "Wooper", "Wormadam", "Xatu", "Xerneas", "Yamask", "Zacian", "Zamazenta", "Zapdos", "Zarude", "Zigzagoon", "Zoroark", "Zorua", "Zubat", "Zygarde"]
POKEMON_TIERS = {
...
class Pokedex(object):
    ...
    @staticmethod
    def alternate(pokemon):
        return pokemon in POKEMON_WITH_ALTERNATE_VERSIONS
